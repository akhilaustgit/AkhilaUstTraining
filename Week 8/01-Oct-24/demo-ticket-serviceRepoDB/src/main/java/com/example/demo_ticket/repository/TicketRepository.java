...
//JpaRepository is inbuilt repo in spring
//CrudRepository also used instead of JpaRepository. another repo is PagingAndSortingRepository.
	public List<Ticket> findByFromplaceAndToplace(String from_place, String to_place);
